...
<template>
  ...
  <div v-if="formError" class="mb-4 p-3 rounded-lg bg-red-50 text-red-700">
    {{ formError }}
  </div>

  <div class="max-w-7xl mx-auto p-6">
    <h1 class="text-2xl font-bold mb-2">Resources</h1>
    <p class="text-gray-500 mb-6">Manage organization resources</p>

    <!-- TOP: FORM + PREVIEW -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
      <!-- FORM -->
      <div class="bg-white rounded-2xl shadow-sm border p-6">
        <h2 class="font-semibold text-lg mb-4">Resource Information</h2>
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="text-sm">Featured Resource</span>
          </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border w-full">
      <div class="p-5 border-b">
        <h2 class="font-semibold text-lg">Resources List</h2>
      </div>
        ...
        <table class="w-full min-w-full">
          ...
          <tbody>
            ...
            >
              ...
              <td class="p-4">
                <span class="px-2 py-1 rounded-full bg-gray-100 text-sm">
                  {{ resource.type }}
                </span>
              </td>
  ...
  >
    <div class="bg-white rounded-2xl p-6 w-full max-w-md">
      <h3 class="text-lg font-semibold mb-2">Delete Resource</h3>
